...
public abstract class TransactionBaseObject implements Serializable {
    ...
    public TransactionBaseObject() {
    }

    public TransactionBaseObject(String createdBy, ZonedDateTime createdDate, String updatedBy, ZonedDateTime updatedDate, String recordID) {
